...
public class User {
	...
	public void setFirstName(String firstName) {
		...
		if(firstName.matches(NAME_PATTERN) && !firstName.isEmpty()){
			if(firstName.length() < 20){
				...
				this.firstName = firstName.substring(0,19);
			}
		}
	}
	...
	public void setLastName(String lastName) {
		//contains no digits
		if(lastName.matches(NAME_PATTERN) && !lastName.isEmpty()){
			if(lastName.length() < 20){
				this.lastName = lastName;
			}
			else{
				this.lastName = lastName.substring(0,19);
			}
		}
	}
	...
	public void addNotification(Notification notif){
		this.notifications.put(notif.getId(), notif);
	}
